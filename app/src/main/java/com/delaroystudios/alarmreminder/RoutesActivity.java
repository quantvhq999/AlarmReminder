...
import com.delaroystudios.alarmreminder.Adapter.IClickListenerRouteAdapter;
import com.delaroystudios.alarmreminder.Adapter.RouteAdapter;
import com.delaroystudios.alarmreminder.Database.DBRoutes;
import com.delaroystudios.alarmreminder.Model.Route;
import com.delaroystudios.alarmreminder.Service.AlarmService;

import java.util.ArrayList;

import static com.delaroystudios.alarmreminder.NewRouteActivity.iDRunRoute;
import static com.delaroystudios.alarmreminder.NotificationActivity.isTimeUp;
import static com.delaroystudios.alarmreminder.SettingActivity.REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION_RESULT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it = new Intent(RoutesActivity.this, MainActivity.class);
                startActivity(it);
            }
        });
